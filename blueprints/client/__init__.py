...
from blueprints._messages import register as _register_messages
...
_register_messages(client_bp, roles=("client_admin", "client_user"))
_register_notifications(client_bp, roles=("client_admin", "client_user"))
