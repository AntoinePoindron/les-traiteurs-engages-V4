...
def test_back_button_with_history(app):
    out = _render(app, '{% from "components/ui.html" import back_button %}{{ back_button() }}')
...
def test_back_button_with_href(app):
    out = _render(app, '{% from "components/ui.html" import back_button %}'
...
def test_info_chip_with_label(app):
    out = _render(app, '{% from "components/ui.html" import info_chip %}'
...
def test_contact_card_caterer_full(app):
    out = _render(app, '{% from "components/ui.html" import contact_card %}'
...
def test_submit_button(app):
    out = _render(app, '{% from "components/ui.html" import submit_button %}'
...
def test_confirm_dialog_default_variant(app):
    out = _render(app, '{% from "components/confirm_dialog.html" import confirm_dialog %}'
