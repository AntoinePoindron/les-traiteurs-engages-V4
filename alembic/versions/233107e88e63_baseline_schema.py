...
Revision ID: 233107e88e63
Revises: 
Create Date: 2026-04-24 12:47:30.108861
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['company_id'], ['companies.id'], ),
    sa.ForeignKeyConstraint(['service_id'], ['company_services.id'], ),
    ...
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['company_id'], ['companies.id'], ),
    sa.ForeignKeyConstraint(['company_service_id'], ['company_services.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('quote_request_caterers',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    sa.Column('amount_per_person', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('valorisable_agefiph', sa.Numeric(precision=12, scale=2), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['client_admin_id'], ['users.id'], ),
